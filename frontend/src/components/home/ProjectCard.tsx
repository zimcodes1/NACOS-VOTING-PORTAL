      ...
      >
        ...
        <div className="relative h-48 w-full bg-background overflow-hidden rounded-xl">
          ...
          <div className="absolute top-3 left-3 right-3 flex items-center justify-between gap-2">
            ...
            {exhibit && <Badge
              variant={project.track === "software" ? "primary" : "gold"}
              size="sm"
              className="shadow-sm backdrop-blur-md"
            >
              {project.track === "software" ? "Software Track" : "Design Track"}
            </Badge>}
          </div>
        ...
        <div className="pt-5 flex-1 flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            ...
            {exhibit && <p className="text-xs font-medium text-text-secondary line-clamp-2 leading-relaxed">
              {project.tagline}
            </p>}
          </div>
          ...
          {exhibit && <div className="pt-2 border-t border-border/60 space-y-2">
          ...
          {/* Action Row: Live Demo Link & Vote Button */}
